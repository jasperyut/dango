...
void KdStandardShader::DrawModel(const KdModel* model,const float _alpha, const Math::Vector3& color, const std::vector<Math::Matrix>* nodeTransforms)
{
	if (model == nullptr)return;
